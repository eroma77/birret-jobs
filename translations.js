window.TRANSLATIONS = {
  ru: {
    ...
    favEmptyDesc: "Нажмите на иконку сердечка на карточке вакансии, чтобы сохранить её сюда.",
    ...
    btnGoogleAuth: "Войти / Зарегистрироваться",
  ...
  kk: {
    ...
    favEmptyTitle: "Таңдаулылар бос",
    favEmptyDesc: "Өзіңізге ұнаған жұмыс карточкасындағы жүрекше белгісін басып қосыңыз.",
    ...
    labelRemote: "Удаленно",
    placeholderAddress: "Мысалы: Мкр. Жетысу-2, дом 45",
    ...
    sortAlphabetical: "Алфавит бойынша (А-Я)",
    ...
    filterExcludeLabel: "Мамандықтарды шектеу (Исключить)",
    filterExcludePlaceholder: "Шектеу үшін іздеу...",
    filterAgeLabel: "Сіздің жасыңыз",
    filterAgePlaceholder: "Мысалы: 25",
    filterAgeDesc: "Сіздің жасыңыз жұмыс беруші талап еткен жас аралығына сәйкес келетіндерін сүзеді",
    filterRemoteLabel: "Тек қашықтан жұмыс (Удаленно)",
    btnApply: "Қолдану",
    btnReset: "Тазалау",
    ...
    detailsCriteriaYearsTo: "дан",
    btnContactWa: "WhatsApp арқылы хабарласу",
    
    // Empty feed
    emptyFeedTitle: "Жұмыстар табылмады",
    emptyFeedDesc: "Сүзгі көрсеткіштерін өзгертіп немесе тазалап көріңіз.",
